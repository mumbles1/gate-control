      ...
      <div className="editor-grid">
        ...
        {!gate.simulated && <section className="form-card">
          ...
          <div className="form-grid form-grid--two">
            ...
            <label className="field"><span>Host</span><input placeholder="property.turnageautomation.com" value={gate.broker.host} onChange={(event) => setBrokerAddress("host", event.target.value)} /></label>
