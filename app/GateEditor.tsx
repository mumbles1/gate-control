      ...
      <div className="editor-grid">
        ...
        <section className="form-card">
          ...
          <div className="form-grid form-grid--two">
            ...
            <label className="field"><span>Host</span><input placeholder="ws.turnageautomation.com" value={gate.broker.host} onChange={(event) => setBrokerAddress("host", event.target.value)} /></label>
            ...
            <label className="field"><span>Base path <em>WebSocket only</em></span><input placeholder="Property" value={gate.broker.basePath} onChange={(event) => setBrokerAddress("basePath", event.target.value)} /></label>
